...
let ReviewsResolver = class ReviewsResolver {
    ...
    createReview(user, input) {
        return this.reviewsService.create(user.id, input.requestId, input.revieweeId, input.rating, input.comment);
    }
    userReviews(userId, limit) {
        return this.reviewsService.findByUser(userId, limit);
    }
    userStats(userId) {
        return this.reviewsService.getUserStats(userId);
    }
    canReview(user, requestId, revieweeId) {
        return this.reviewsService.canReview(user.id, requestId, revieweeId);
    }
};
exports.ReviewsResolver = ReviewsResolver;
__decorate([
    (0, graphql_1.Mutation)(() => review_dto_1.Review),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, graphql_1.Args)('input')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, review_dto_1.CreateReviewInput]),
    __metadata("design:returntype", void 0)
], ReviewsResolver.prototype, "createReview", null);
__decorate([
    (0, graphql_1.Query)(() => [review_dto_1.Review]),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
...
__decorate([
    (0, graphql_1.Query)(() => review_dto_1.UserStats),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, graphql_1.Args)('userId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ReviewsResolver.prototype, "userStats", null);
__decorate([
    (0, graphql_1.Query)(() => Boolean),
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthGuard),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, graphql_1.Args)('requestId')),
    __param(2, (0, graphql_1.Args)('revieweeId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, String]),
    __metadata("design:returntype", void 0)
], ReviewsResolver.prototype, "canReview", null);
